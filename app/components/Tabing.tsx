          ...
          <Button
            ...
            className={` ${
              currentPath === option.href
                ? " bg-blue-500 hover:bg-white hover:text-blue-600  text-gray-50"
                : "bg-white  text-blue-600"
            } text-sm  md:text-base flex-1  hover:bg-blue-500 hover:text-white border border-blue-600 w-fit duration-150`}
          >
