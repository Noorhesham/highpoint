      ...
      <MaxWidthWrapper>
        <GridContainer cols={8}>
          <div className="col-span-5">
            <Paragraph
              description="ما هي تعليقات المشاركين عن دورات جلوماكس التدريبية؟
آراء عملائنا تتحدث عن نفسها!

قدّمت جلوماكس دورات تدريبية لآلاف العاملين في مختلف المجالات و الصناعات في القطاعين الحكومي و الخاص في جميع أنحاء العالم، و نتلقى بشكل مستمر تعليقات رائعة و متميزة حول ما نقدمه من دورات تتسم بالجودة العالية و مراعاة أحدث المعايير في التدريب. مُبين أدناه بعض التعليقات التي تلقيناها من المشاركين في دوراتنا التدريبية.

 الآراء التالية مقتبسة من تعليقات حقيقية قدّمها المشاركون في الدورات التدريبية السابقة، و يتم تحديثها بشكل دائم عند إتمام كل دورة تدريبية. نسعى جاهدين وراء النجاح و دائماً ما نجدُ تشجيعاً فيما نتلقاه من تعليقاتٍ إيجابية ومحفزة على المُضي نحو الأفضل. شارك في فاعليات جلوماكس بحضور إحدى دوراتنا التدريبية.
